...
const GaokaoAgentFormComponent = ({ onSubmit }: GaokaoAgentFormProps) => {
  ...
  return (
    <div className="border border-[#C8D8EA] bg-[#F8FBFF] p-6">
      <h2
        id="form-title"
        className="mb-2 text-3xl font-semibold text-[#102033]"
      >
        填写您的高考信息
      </h2>
      <p id="form-description" className="mb-6 text-sm leading-6 text-[#35506B]">
      ...
      >
        {/* 基本信息卡片 */}
        <Card
          className="border-[#C8D8EA] bg-white p-5 shadow-none"
          role="group"
          aria-labelledby="basic-info-heading"
        >
          <h3
            id="basic-info-heading"
            className="mb-4 text-xl font-semibold text-[#102033]"
          >
            基本信息
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label htmlFor="totalScore" className="text-[#35506B]">
              ...
              <Input
                ...
                className="bg-white border-[#C8D8EA] text-[#102033] placeholder-[#64748B] focus:border-[#1F5E99] focus:ring-[#1F5E99]"
              />
            ...
            <div className="space-y-2">
              <Label htmlFor="rank" className="text-[#35506B]">
            ...
            <div className="space-y-2">
              <Label htmlFor="subject" className="text-[#35506B]">
                选科组合 <span className="text-red-500">*</span>
              </Label>
              <Select value={subjectGroup} onValueChange={setSubjectGroup}>
                <SelectTrigger className="bg-white border-[#C8D8EA] text-[#102033]">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-white border-[#C8D8EA] text-[#102033]">
        ...
        {/* 各科成绩卡片 */}
        <Card className="border-[#C8D8EA] bg-white p-5 shadow-none">
          <h3 className="mb-4 text-xl font-semibold text-[#102033]">
            各科成绩（可选）
          </h3>
          <p className="mb-4 text-sm leading-6 text-[#35506B]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {/* 必考科目 */}
            <div className="space-y-2">
              <Label htmlFor="chinese" className="text-[#35506B]">语文</Label>
              <Input
                id="chinese"
                type="number"
                max="150"
            ...
            <div className="space-y-2">
              <Label htmlFor="math" className="text-[#35506B]">数学</Label>
              <Input
                id="math"
                type="number"
                max="150"
            ...
            <div className="space-y-2">
              <Label htmlFor="english" className="text-[#35506B]">英语</Label>
              <Input
                id="english"
                type="number"
                max="150"
            ...
            {subjectGroup === "物理" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="physics" className="text-[#35506B]">物理</Label>
                  <Input
                    id="physics"
                    type="number"
                    max="100"
                ...
                <div className="space-y-2">
                  <Label htmlFor="chemistry" className="text-[#35506B]">化学</Label>
                  <Input
                    id="chemistry"
                    type="number"
                    max="100"
                ...
                <div className="space-y-2">
                  <Label htmlFor="biology" className="text-[#35506B]">生物</Label>
                  <Input
                    id="biology"
                    type="number"
                    max="100"
            ...
            {subjectGroup === "历史" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="history" className="text-[#35506B]">历史</Label>
                  <Input
                    id="history"
                    type="number"
                    max="100"
                ...
                <div className="space-y-2">
                  <Label htmlFor="politics" className="text-[#35506B]">政治</Label>
                  <Input
                    id="politics"
                    type="number"
                    max="100"
                ...
                <div className="space-y-2">
                  <Label htmlFor="geography" className="text-[#35506B]">地理</Label>
                  <Input
                    id="geography"
                    type="number"
                    max="100"
        ...
        <Card className="border-[#C8D8EA] bg-white p-5 shadow-none">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="preferredMajors" className="text-[#35506B]">
                想学的专业方向
              </Label>
              <Input
                id="preferredMajors"
            ...
            <div className="space-y-2">
              <Label htmlFor="blacklistMajors" className="text-[#35506B]">
                不想学的专业（黑名单）
              </Label>
              <Input
                id="blacklistMajors"
            ...
            <div className="space-y-2">
              <Label htmlFor="preferredCities" className="text-[#35506B]">
                偏好城市/地区
              </Label>
              <Input
                id="preferredCities"
            ...
            <div className="space-y-2">
              <Label htmlFor="risk" className="text-[#35506B]">
                风险偏好
              </Label>
        ...
        <Button
          type="submit"
          className="w-full rounded-none bg-[#1F5E99] py-6 text-lg font-bold text-white shadow-none transition hover:bg-[#164A7A]"
        >
          开始证据化分析
        </Button>
      </form>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-[#C8D8EA] bg-white p-4">
          <h4 className="mb-2 font-semibold text-[#102033]">核心算法</h4>
          <ul className="space-y-1 text-sm text-[#35506B]">
            <li>• 历史位次区间对照</li>
            <li>• 数据年份透明提示</li>
            <li>• 小样本与波动风险惩罚</li>
          </ul>
        ...
        <div className="border border-[#C8D8EA] bg-white p-4">
          <h4 className="mb-2 font-semibold text-[#102033]">风险管控</h4>
          <ul className="space-y-1 text-sm text-[#35506B]">
            <li>• 调剂地狱模拟器</li>
            <li>• 黑名单专业预警</li>
            <li>• 4级审计机制</li>
