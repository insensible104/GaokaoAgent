...
assert.match(markup, /Admissions opportunity demo case/);
...
assert.match(markup, /Public opinion guard/);
...
assert.match(markup, /Search run/);
assert.match(markup, /web_evidence_search_run_v1/);
assert.match(markup, /completed/);
assert.match(markup, /Gap rerun/);
assert.match(markup, /evidence_gap_search_rerun_v1/);
assert.match(markup, /no_gaps/);
assert.match(markup, /6 merged evidence results/);
assert.match(markup, /4 normalized evidence results/);
assert.match(markup, /operator captures/i);
...
assert.match(markup, /Decision brief/);
...
assert.match(markup, /Concept readiness/);
