...
Manufacturing-data and intelligent-manufacturing evidence may reveal a differentiated opportunity path that generic computer-science-oriented counseling can miss. This is a research hypothesis to investigate, not a student recommendation.

## Sources

### 1. Official enrollment-plan change signal

- Source title: 华南理工大学本科招生网 - 招生计划
- URL: https://admission.scut.edu.cn/30820/list.htm
...
- Source title: 华南理工大学本科招生网 - 历年录取分数线
- URL: https://admission.scut.edu.cn/30821/list.htm
- Captured at: 2026-06-24
- Source type: official
- Claim task id: rank-history-band
- Accepted excerpt: 2025 广东物理类工科试验班(智能装备与先进制造)：最高 644，最低 629，平均 631.9。
- Confidence: high
- Review action: Keep the official query parameters with the fixture: year 2025, province Guangdong, category 普通类, subject 理工/物理类.
- What this does not prove: It is score evidence, not rank evidence; it does not prove a 2026 cutoff, admission probability, or future group composition.

### 4. School/faculty/major training evidence

- Source title: 华南理工大学吴贤铭智能工程学院 - 智能制造工程专业介绍
- URL: https://www2.scut.edu.cn/wusie/2022/0907/c34046a488201/page.htm
- Captured at: 2026-06-24
- Source type: school
...
### 5. Undergraduate research and lab-access evidence
...
### 6. Progression or career-path evidence

- Source title: 华南理工大学吴贤铭智能工程学院 - 招生
- URL: https://www2.scut.edu.cn/wusie/34045/list.htm
- Captured at: 2026-06-24
- Source type: school
...
### 7. Counter-evidence or explicit evidence gap

- Source title: 华南理工大学 2025 年广东省综合评价招生简章
- URL: https://xxgk.scut.edu.cn/2025/0402/c108a48077/page.htm
- Captured at: 2026-06-24
- Source type: official
- Claim task id: counter-evidence
- Accepted excerpt: 学费：9.5 万元/生·学年；不可转入其它校区的专业。
- Confidence: high
- Review action: Flag cost, campus, and transfer constraints separately from ordinary-batch evidence; confirm whether the candidate path involves comprehensive evaluation.
- What this does not prove: It does not prove the ordinary-batch major has the same cost or transfer rule; it only marks a material risk for adjacent admission routes.

## Evidence Taste Notes

- Admission evidence is useful only as historical context until 2026 provincial groups, plans, ranks, and candidate rank are known.
- School pages can support training-path hypotheses, but they are not outcome data.
- The case becomes product-worthy only if Evidence Autopilot preserves these boundaries when generating Opportunity Radar signals and the Chinese report.
